...
public class PIDFController {
    ...
    // TODO: i don't really like this system of feedforward, since it is not always linear. make a
    // customizable version of feedforward, takes in a function of setpoint and returns a value through a
    // anonymous helper function? (interface)

    // for example, kCos, linear, constant can be a good option

    // add a maxpower argument too
